...
//  Fields making up the MW1-7 elements
    ...
    // CouchbaseBucket
    static Bucket Bucket= CouchbaseClientFactory.getInstance("noaa","");
    ...
    public static void main(String[] args) {
        try {
            Files.walk(Paths.get("/usr")).forEach(System.out::println);
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
...
// Build Mandatory Data Section + the rest of the record
        ...
        JsonDocument testVal = Bucket.get("010014-99999::2012-12-21");
        System.out.println(testVal.content());
